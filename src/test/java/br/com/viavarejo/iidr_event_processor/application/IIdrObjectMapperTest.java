...
import br.com.viavarejo.iidr_event_processor.application.IIdrObjectMapper;
...
public class IIdrObjectMapperTest {
    ...
    public void testProcessors() {
        ...
        for (Listener listener : listenerList) {
            try {
                rightEntityImplementation = (RightEntityImplementation) IIdrObjectMapper.mapObject(listener.entityProcessor, jsonObject);
